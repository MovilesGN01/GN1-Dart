          ...
          Container(
            ...
            child: Center(
              child: Column(
                ...
                children: [
                  Icon(
                    _status == _NfcStatus.scanning ? Icons.nfc_rounded : Icons.contactless_rounded,
                    size: 72,
                    color: statusData.accent,
                  ),
                  const SizedBox(height: 14),
                  Text(
                    _status == _NfcStatus.scanning ? 'Scanning...' : 'Ready to scan',
                    style: GoogleFonts.poppins(
                      fontSize: 18,
                      fontWeight: FontWeight.w600,
                      color: const Color(0xFF0F172A),
            ...
            children: [
              Expanded(
                child: ElevatedButton.icon(
                  ...
                  label: Text(
                    _status == _NfcStatus.scanning ? 'Scanning...' : 'Start scan',
                  ),
                  style: ElevatedButton.styleFrom(
                    minimumSize: const Size(0, 54),
                    backgroundColor: const Color(0xFF1F5DFF),
                    foregroundColor: Colors.white,
                    disabledBackgroundColor: const Color(0xFF1F5DFF).withOpacity(0.45),
